...
When you write a sentence, ask: "If a lawyer put this in a client email, would they cite the statute, or would they cite a Cooley alert?" If the answer is the statute, use Bucket A. If the answer is the Cooley alert, use Bucket B.
